      ...
      <div className="overflow-hidden rounded-lg bg-white shadow">
        <div className="px-4 py-5 sm:p-6">
          <div className="sm:flex sm:items-center sm:justify-between mb-6">
            <div>
              <h3 className="text-lg font-medium text-gray-900">Check History</h3>
              <p className="mt-1 text-sm text-gray-500">
                Showing {startIndex + 1} to {Math.min(endIndex, sortedChecks.length)} of {sortedChecks.length} checks
              </p>
            </div>
          </div>
              ...
              <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-gray-700">
                    ...
                    <span className="font-medium">{Math.min(endIndex, sortedChecks.length)}</span> of{' '}
                    <span className="font-medium">{sortedChecks.length}</span> results
                  </p>
                </div>
                <div>
